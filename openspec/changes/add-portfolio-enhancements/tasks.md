...
- [x] 1.2 完善 `specs/ui/spec.md`：定义磁吸按钮和标签动画的参数
- [x] 1.3 编写 `specs/resume/spec.md`：定义简历预览的功能要求

## 2. Component Development
- [x] 2.1 开发 `MagneticButton`：基于 Framer Motion 实现
- [x] 2.1.1 优化 `MagneticButton`：增加 `maxDistance` 位移限程控制
